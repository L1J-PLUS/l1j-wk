...
public class L1DragonPortalInstance extends L1NpcInstance {
	...
	public void onTalkAction(L1PcInstance player) {
		...
		if ((npcid >= 81273 && npcid <= 81276)) { // 龍之門扉
			...
			L1Teleport.teleport(player, 32807, 32803, player.getMapId(), 6, true);
		}
		else if (npcid == 97078) { // teleport into Cave of Fafurion
			L1Teleport.teleport(player, 32761, 32724, player.getMapId(), 6, true);
		}
