	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			try {
				...
				if (npcid == 0) {
					pc.sendPackets(new S_SystemMessage("no such npc."));
					return;
				}
			}
			int count = 1;
			...
			pc.sendPackets(new S_SystemMessage(nameid + "(ID:" + npcid + ") (" + count + ") summoned."));
		}
		catch (Exception e) {
			pc.sendPackets(new S_SystemMessage("Please enter " + cmdName + " npcid|name number "));
		}
	}
}
