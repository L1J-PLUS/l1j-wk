	...
	private class ServerShutdownThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				world.broadcastServerMessage("Server about to be shut down.");
				world.broadcastServerMessage("Please move to safe area and log out.");
				while (0 < secondsCount) {
					if (secondsCount <= 30) {
						world.broadcastServerMessage("Server will be shut down in " + secondsCount
								+ " seconds, please move to safe area and log out.");
					} else {
				...
				world.broadcastServerMessage("Server shut down is cancelled.");
				return;
			}
		}
	}
